<?php
    ...
    if (isset($_POST['email'])) {
        ...
        $sql = $conn->query("SELECT idUsers FROM users WHERE usersEmail='$email'");
        if ($sql->num_rows > 0) {
          ...
          $mail->Username = 'jestectester@gmail.com';
          $mail->Password = 'jestecislife';
          $mail->Port = 587;
          $mail->SMTPSecure = "tls";
          $mail->SMTPKeepAlive = true;
	        ...
	        $mail->setFrom("jestectester@gmail.com", "JESTEC");
	        ...
	        $mail->Body = "
	            ...
	            <a href='
	            http://localhost/ForgotPasswordSystem/resetPassword.php?email=$email&token=$token
	            '>http://localhost/ForgotPasswordSystem/resetPassword.php?email=$email&token=$token</a><br><br>
