...
if (mysqli_num_rows($result) > 0) {
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo '" class="row rounded text-light shadow-sm details manuscript-item ';
    ...
    echo '">';
      ...
      echo '<div class="col-sm-2 manuscript-details">';
        echo $row['idManuscript'];
      echo "</div>";
      // Display Manuscript Title
      echo '<div class="col-sm-5 manuscript-details manutitle">';
      ...
      echo "</div>";
      // Display buttons
      echo '<div class="col-sm-1 manuscript-details action-btns">';
  ...
  echo "<p class='text-light text-center'>You have no manuscripts to review.</p>";
}
?>
    </div>
  </div>
