				...
				<div>
				    <div class="card" style="width: 18rem">
				    	<div class="card-body">
				    		<h5 class="card-title">
				    			Jump to
				    			<small class="text-muted"><a class="btn-sm btn-secondary float-right" href="archive.php"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-arrow-left-short" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M12 8a.5.5 0 0 1-.5.5H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5a.5.5 0 0 1 .5.5z"/>
				...
				<div class="container text-light">
			    	...
			    	<div class="d-flex mb-4">
			    		...
			    		<div class="ml-auto">
			    			<button type="button" class="btn btn-sm btn-outline-info">Cite This</button>
			    ...
			    <div class="scrollspy-target" data-spy="scroll" data-target="#list-example" data-offset="0">	
		    		<div class="media-border">
				    	...
				    	<p>
				    		<span class="badge badge-info">Keyword1</span>
				    		<span class="badge badge-info">Keyword1</span>
				    	</p>
				    </div>
